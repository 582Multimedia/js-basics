...
> [!WARNING]
> If you make copies of arrays and objects, we need to make **deep** copies, meaning they are brand generated brand from new and not a reference copy like we saw.
